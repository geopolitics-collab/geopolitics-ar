...
SECTIONS = [
    ...
    ("asie_ame", "/asie.html",      "#1a8a6e", "آسيا وأمريكا", "آسيا",
     ["japon-armement-pologne-philippines-2026","usa-blocus-maritime-iran-petrole-2026",
      ...
      "top-10-bases-militaires-asie-guerre",
      "top-7-armees-asiatiques-chine",
      "taiwan-conflit-historique-pekin",
      "chine-armes-secretes-taiwan",
      "chine-usa-mer-chine-controle",
]),
    ("orient",   "/proche-or.html", "#8b3a8b", "الشرق الأوسط", "شرق أوسط",
     ["moyen-orient-iran-arabie-rivalite-structurante","afrique-nouvelle-grande-competition",
      ...
      "top-10-armees-arabes-2026",
      "maroc-algerie-soutien-guerre",
      "algerie-armee-otan-inquiete",
      "egypte-vs-turquie-militaire",
      "systemes-anti-aeriens-moyen-orient",
      "israel-surveille-armees-arabes",
      "armee-arabe-inquiete-israel",
      "pays-musulmans-armes-modernes",
]),
    ("europe",   "/eu.html",        "#1e5fa8", "أوروبا", "أوروبا",
     ["ukraine-otan-guerre-mondiale-procuration","corps-controle-mobilisation-civile-europe",
      ...
      "drones-guerres-modernes-revolution",
      "nouvelles-armes-conflits-futurs",
]),
    ("afrique",  "/afr.html",       "#c8821a", "أفريقيا العسكرية", "أفريقيا",
     ["bases-militaires-usa-afrique-secretes",
      "drones-turcs-guerres-africaines",
      "forces-speciales-africaines-redoutees",
      "russie-militaire-afrique-avance",
      "15-armes-dangereuses-sahel",
      "afrique-pays-renforcent-armee",
      "afrique-pays-plus-chars",
      "top-10-puissances-militaires-maghreb",
      "armees-africaines-equipees-russie",
      "chine-usa-geopolitique-afrique",
      "sahel-centre-guerres-mondiales"]),
]
